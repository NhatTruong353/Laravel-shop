                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input required name="qty" id="qty"
                                                       placeholder="Quantity" type="number" class="form-control" value="{{$product->qty}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <div class="position-relative form-check pt-sm-2">
                                                    <input name="featured" id="featured" type="checkbox" value="1" {{$product->featured == 1 ? 'checked' : ''}} class="form-check-input">
