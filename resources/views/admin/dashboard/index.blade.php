        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card mb-3 widget-content bg-love-kiss">
                    <div class="widget-content-wrapper text-white">
                        <div class="widget-content-left">
                            <div class="widget-heading">Order Canceled</div>
                        </div>
                        <div class="widget-content-right">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body display_data">
                        <div class="table-responsive">
                            <h2 class="text-center">Top 5 Best Seller Products In Month</h2>
                            <hr>
                                                    ...
                                                    <div class="widget-content-left mr-3">
                                                        <div class="widget-content-left">
                                                            <img style="height: 60px;"
                                                                 ...
                                                                 src="front/img/products/{{ $product->path }}" alt="">
                                                        </div>
                                                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body display_data">
                        <div class="table-responsive">
                            <h2 class="text-center">Top 5 Product Canceled</h2>
                            <hr>
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                <thead>
                                <tr>
