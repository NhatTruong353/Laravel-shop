                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    <form action="/admin/coupon/{{$coupon->id}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <select required name="type" id="type" class="form-control">
                                                    ...
                                                    @foreach(\App\Utilities\Constant::$coupon_status as $key => $value)
                                                        <option value={{$key}} {{$coupon->type == $key ? 'selected' : ''}}>
                                                            {{$value}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input name="value" id="company_name"
                                                    placeholder="Coupon value" type="number" class="form-control"
                                                    value="{{ $coupon->value }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input name="cart_value" id="cart_value" placeholder="Cart Value"
                                                    type="number" class="form-control" value="{{ $coupon->cart_value }}">
                                            </div>
                                        </div>
