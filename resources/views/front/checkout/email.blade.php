...
<head>
    ...
    <title>Order Notification | T-shop eCommerce</title>
</head>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        <div class="col-6"
                            ...
                            <b>{{ $usermeta->first_name . ' ' . $usermeta->last_name }}</b>
                            <br>
                            <span>
                        ...
                        <div class="col-6" style="flex: 0 0 50%; width: 50%; box-sizing: border-box;">
                            ...
                            <br>
                            <b>Address:</b> {{ $usermeta->street_address . ' - ' .  $usermeta->town_city }}
