                            ...
                            <div class="col-lg-7 col-md-7">
                                <form action="">
                                    <div class="select-option">
                                        <select id="sort_by" name="sort_by" class="sorting" onchange="this.form.submit();">
                                            <option {{ request('sort_by') == 'latest' ? 'selected' : ''}} value="latest">Sorting: Latest</option>
                                            <option {{ request('sort_by') == 'oldtest' ? 'selected' : ''}} value="oldtest">Sorting: Oldtest</option>
                                        ...
                                        <select id="show" name="show" class="p-show" onchange="this.form.submit();">
